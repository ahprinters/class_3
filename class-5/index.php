    ...
    <div class="page-wrapper">
        <header class="header header-2 header-intro-clearance">
            <?php
                ...
                include_once "web-header-top.php";
                include_once "web-header-middle.php";
                include_once "web-header-bottom.php";
        ...
        <main class="main">
            ...
            <?php
                ...
                include_once "web-slider-container.php";
                include_once "web-owl-carousel.php";
                include_once "web-banner-group.php";
                include_once "web-tab-container.php";
            ?>
